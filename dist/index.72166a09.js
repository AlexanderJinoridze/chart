...
var _modeSwitcher = require("./modeSwitcher");
...
_parcelHelpers.export(exports, "modeSwithcer", function () {
  return modeSwithcer;
});
function modeSwithcer(switcher, theme = "day") {
...
var _bottomChart = require("./bottomChart");
const WIDTH = 600;
const HEIGHT = 200;
const PADDING = 40;
...
function chart(root, data) {
  ...
  checkBox.subscribe(filter => {
    proxy.filter = filter;
    _bottomChart.bottomChart(root.querySelector("[data-el='slider']"), DPI_WIDTH, data, filter);
  });
  ...
  function paint() {
    ...
    const [yMin, yMax] = _utils.boundaries({
      columns,
      types: data.types
    });
    const xRatio = _utils.computeXRatio(VIEW_WIDTH, columns[0].length);
    const yRatio = _utils.computeYRatio(VIEW_HEIGHT, yMax, yMin);
    ...
    yData.map(_utils.toCoords(xRatio, yRatio, DPI_HEIGHT, PADDING, yMin)).forEach((coords, idx) => {
  ...
  function xAxis(xData, yData, xRatio) {
    ...
    for (let i = 1; i < xData.length; i++) {
      const x = i * xRatio;
      if ((i - 1) % step === 0) {
        const text = _utils.toDate(xData[i]);
        ctx.fillText(text.toString(), x, DPI_HEIGHT - 10);
      }
      if (_utils.isOver(proxy.mouse, x, xData.length, DPI_WIDTH)) {
        ctx.save();
...
},{"./tooltip":"1RUfP","./utils":"3EQWo","./slider":"6zrPB","./checkboxes":"5M1MK","./bottomChart":"6MJkm","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1RUfP":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"3EQWo","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3EQWo":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "computeYRatio", function () {
  return computeYRatio;
});
_parcelHelpers.export(exports, "computeXRatio", function () {
  return computeXRatio;
});
...
_parcelHelpers.export(exports, "boundaries", function () {
  return boundaries;
});
...
function line(ctx, coords, {color, translate = 0}) {
  ctx.beginPath();
  ctx.save();
  ctx.lineWidth = 4;
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6zrPB":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"3EQWo","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5M1MK":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "checkBoxes", function () {
  return checkBoxes;
});
function noop() {}
function checkBoxes(root, data) {
  let nextFn = noop;
  let filter = {};
  function next() {
    nextFn(getFilter());
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6MJkm":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "bottomChart", function () {
  return bottomChart;
});
var _utils = require("./utils");
function bottomChart(root, DPI_WIDTH, data, filter) {
  ...
  const [yMin, yMax] = _utils.boundaries(filteredData);
  const xRatio = _utils.computeXRatio(DPI_WIDTH, columns[0].length);
  const yRatio = _utils.computeYRatio(DPI_HEIGHT, yMax, yMin);
  const yData = columns.filter(col => data.types[col[0]] === "line");
  yData.map(_utils.toCoords(xRatio, yRatio, DPI_HEIGHT, 0, yMin)).forEach((coords, idx) => {
    const color = data.colors[yData[idx][0]];
    _utils.line(ctx, coords, {
      color
    });
